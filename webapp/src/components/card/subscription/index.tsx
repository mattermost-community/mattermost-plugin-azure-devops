...
const SubscriptionCard = ({handleDeleteSubscrption, subscriptionDetails: {channelType, eventType, channelName, createdBy, username}, subscriptionDetails}: SubscriptionCardProps) => (
    <BaseCard>
