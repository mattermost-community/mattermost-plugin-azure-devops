...
export const getIncrementedPaginationQueryParamsValue = (offset: number, limit: number) => {
    return {offset: offset + limit, limit: limit + Constants.common.defaultPageLimit};
};
